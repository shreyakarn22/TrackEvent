...
from .models import Event, EventImage, EventAgenda, UserProfile
...
class EventForm(forms.ModelForm):
    ...
    class Meta:
        model = Event
        fields = ['category', 'name', 'uid', 'description', 'job_category', 'scheduled_status', 'venue', 'start_date', 'end_date', 'points', 'maximum_attende', 'status']
        widgets = {
