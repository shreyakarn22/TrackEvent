...
from .forms import EventForm, EventImageForm, EventAgendaForm, EventCreateMultiForm, UserProfileForm
...
class EventMemberListView(LoginRequiredMixin, ListView):
    login_url = 'login'
    model = EventMember
    template_name = 'events/eventmember_list.html'
...
class RemoveEventMemberDeleteView(LoginRequiredMixin, DeleteView):
    ...
    success_url = reverse_lazy('event-member-list')
